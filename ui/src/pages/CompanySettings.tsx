  ...
  if (!selectedCompany) {
    return (
      <div className="text-sm text-muted-foreground">
        No article selected. Select an article from the switcher above.
      </div>
    );
  }
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-lg font-semibold">Article Settings</h1>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3 rounded-md border border-border px-4 py-4">
          <Field label="Article name" hint="The display name for your article.">
            <input
          ...
          <Field
            label="Description"
            hint="Optional description shown in the article profile."
          >
            <input
              className="w-full rounded-md border border-border bg-transparent px-2.5 py-1.5 text-sm outline-none"
              type="text"
        ...
        <div className="space-y-3 rounded-md border border-border px-4 py-4">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 space-y-3">
              ...
              <Field
                label="Brand color"
                hint="Sets the hue for the article icon. Leave empty for auto-generated color."
              >
                <div className="flex items-center gap-2">
                  <input
                    type="color"
      ...
      <div className="space-y-4" data-testid="company-settings-team-section">
        ...
        <div className="rounded-md border border-border px-4 py-3">
          <ToggleField
            label="Require board approval for new additions"
            hint="New agent additions stay pending until approved by board."
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-md border border-border px-4 py-4">
          <p className="text-sm text-muted-foreground">
            ...
            <a href="/org" className="underline hover:text-foreground">Research Team</a> header.
          </p>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3 rounded-md border border-destructive/40 bg-destructive/5 px-4 py-4">
          <p className="text-sm text-muted-foreground">
            Archive this article to hide it from the sidebar. This persists in
            the database.
          </p>
          <div className="flex items-center gap-2">
            <Button
              ...
              onClick={() => {
                ...
                const confirmed = window.confirm(
                  `Archive article "${selectedCompany.name}"? It will be hidden from the sidebar.`
                );
                if (!confirmed) return;
                const nextCompanyId =
                  companies.find(
