            ...
            <>
              ...
              <div className="text-center space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  We recommend letting your Research Director handle agent setup — they know the
                  research team structure and can configure reporting, permissions, and
                  adapters.
                </p>
              </div>
              ...
              <Button className="w-full" size="lg" onClick={handleAskCeo}>
                ...
                Ask the Research Director to create a new agent
              </Button>
